                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            // softWrap: true,
                            maxLines: 1,
                            style: getBoldStyle(color: ColorTheme.wight,fontSize: 15),// getBoldStyle(color: ColorTheme.white,fontSize: 15),
                          ),
                          const SizedBox(
                            height: 5,
                          ),
                           Text(
                            'Electronic Arts',
                            style: getRegulerStyle(color: ColorTheme.wight,fontSize: 12,),
                          ),
                        ],
                      ),
                    ),
